...
func (h *oauth2LoginCallbackHandler) Pattern() string {
	return "GET /api/v1/login/providers/{provider}/callback"
}

func (h *oauth2LoginCallbackHandler) IsPrivateRoute() bool {
	return false
}
