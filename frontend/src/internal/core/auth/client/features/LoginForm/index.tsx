...
import { OAuth2Button } from '../../components/OAuth2';
import { loginByCredentials } from '../../services';
...
export function LoginForm() {
  ...
  useEffect(() => {
    http.post('api/v1/authentication/session');
  }, []);
  ...
  const onSubmit = async (data: LoginData) => {
    await loginAsync(data, {
      onSuccess: async () => {
        ...
        if (userProfile) {
          dispatch(authSlice.actions.setProfile(await getUserProfile()));
        }
